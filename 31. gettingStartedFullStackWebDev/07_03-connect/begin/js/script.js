                      ...
                      if (
                        ...
                        if (
                          ...
                          for (
                            ...
                            (s._active ||
                              (c >= s._startTime && !s._paused && !s._gc)) &&
                              (s._reversed
                                ? s.render(
                                    (s._dirty
                                      ? s.totalDuration()
              ...
              (function () {
                var t = 180 / Math.PI,
                      ...
                      (c = t[b]),
                        ...
                        h
                          ? ((y = e[l]),
                            (T = i[l]),
                            (w =
                              (0.25 * (T + y) * r) / (a ? 0.5 : s[l] || 0.5)),
                            (f =
                              u -
                              (u - _) * (a ? 0.5 * r : 0 !== y ? w / y : 0)),
                            (m =
                              u +
                              (p - u) * (a ? 0.5 * r : 0 !== T ? w / T : 0)),
                            (d =
                              u -
                              (f +
                                (((m - f) * ((3 * y) / (y + T) + 0.5)) / 4 ||
                  ...
                  l = function (t, s, r, a) {
                    ...
                    if (((o = t.length - 2), 0 > o))
                      return (
                        (c[0] = new n(t[0][s], 0, 0, t[-1 > o ? 0 : 1][s])), c
                      );
                    for (h = 0; o > h; h++)
                      (l = t[h][s]),
                        (_ = t[h + 1][s]),
                        ...
                        parser: function (t, e, n, a, o, h) {
                          ...
                          return (
                            ...
                            !d.autoRotate ||
                              ...
                              ((l =
                                d.autoRotate === !0 ? 0 : Number(d.autoRotate)),
                              (d.autoRotate =
                                null != u.end.left
                  ...
                  var l,
                    ...
                    U = (function () {
                      ...
                      return (
                        ...
                        (c =
                          u &&
                          6 > Number(X.substr(X.indexOf('Version/') + 8, 1))),
                    ...
                    Z = (N.calculateOffset = function (t, e, i) {
                      ...
                      return (
                        t['offset' + s] -
                        (Q(t, e, parseFloat(r), r.replace(y, '')) || 0)
                      );
                    }),
                    $ = function (t, e) {
                      var i,
                      ...
                      if (!o[t]) {
                        ...
                        de(t, {
                          parser: function (t, i, s, r, n, a, h) {
                            var l = (_gsScope.GreenSockGlobals || _gsScope).com
                              .greensock.plugins[e];
                            return l
                              ? (l._cssRegister(),
                                o[s].parse(t, i, s, r, n, a, h))
                        ...
                        if (16 === n.length) {
                          ...
                          if (
                            ...
                            (v.rotationX = H * z),
                              ...
                              (v.scaleX =
                                (0 | (Math.sqrt(Y * Y + j * j) * w + 0.5)) / w),
                              (v.scaleY =
                                (0 | (Math.sqrt(G * G + k * k) * w + 0.5)) / w),
                              (v.scaleZ =
                                (0 | (Math.sqrt(Q * Q + R * R) * w + 0.5)) / w),
                              (v.skewX = 0),
                              (v.perspective = $ ? 1 / (0 > $ ? -$ : $) : 0),
                              (v.x = A),
                              (v.y = O),
                      ...
                      parser: function (t, e, i, s, n, o, h) {
                        ...
                        if ('string' == typeof T.transform && ye)
                          ...
                          'string' == typeof T.x &&
                            ...
                            (l.skewX =
                              null == T.skewX ? d.skewX : re(T.skewX, d.skewX)),
                            (l.skewY =
                              null == T.skewY ? d.skewY : re(T.skewY, d.skewY)),
                            (_ = l.skewY - d.skewY) &&
                        ...
                        for (
                          xe &&
                            ...
                            d.skewType =
                              T.skewType || d.skewType || a.defaultSkewType,
                            c =
                              d.force3D ||
                              d.z ||
                              d.rotationX ||
                  ...
                  (h = a.prototype),
                    ...
                    (h._enableTransforms = function (t) {
                      (this._transformType =
                        ...
                        (this._transform =
                          this._transform || Pe(this._target, r, !0));
                    });
                  var Me = function () {
              ...
              var t = 'ScrollMagic',
                ...
                h = function () {
                  if (
                    ...
                    return void m(
                      1,
                      'ERROR creating object ScrollMagic: No valid scroll container supplied'
                    );
                  (g = !$.contains(document, o.container.get(0))),
                    (u = o.vertical
                      ? o.container.height()
                      : o.container.width()),
                    o.container.on('scroll resize', w);
                  try {
                ...
                p = function () {
                  return o.vertical
                    ? o.container.scrollTop()
                    : o.container.scrollLeft();
                },
                v = function () {
                  if (a && f) {
                    var e = $.isArray(a) ? a : s,
                    ...
                    l = i.scrollPos();
                    var n = l - t;
                    (c = 0 === n ? 'PAUSED' : n > 0 ? 'FORWARD' : 'REVERSE'),
                      i.updateScene(e, !0),
                      0 === e.length &&
                        o.loglevel >= 3 &&
                        m(3, 'updating 0 Scenes (nothing added to controller)'),
                      (a = !1);
                  }
                },
                w = function (e) {
              ...
              return (
                (this.addScene = function (e) {
                  return (
                    $.isArray(e)
                      ...
                      : -1 == $.inArray(s, e) &&
                        (s.push(e),
                        $.each(o.globalSceneOptions, function (t, n) {
                          e[t] && e[t].call(e, n);
                        }),
                        m(3, 'added Scene (' + s.length + ' total)')),
                    i
                  );
                }),
                (this.removeScene = function (e) {
                  if ($.isArray(e))
                    ...
                    t > -1 &&
                      (s.splice(t, 1),
                      e.remove(),
                      m(3, 'removed Scene (' + s.length + ' total)'));
                  }
                  return i;
                }),
                ...
                (this.info = function (e) {
                  ...
                  return arguments.length
                    ? void 0 !== t[e]
                      ? t[e]
                      : void m(1, 'ERROR: option "' + e + '" is not available')
                    : t;
                }),
                (this.loglevel = function (e) {
                  return arguments.length
                    ? (o.loglevel != e && (o.loglevel = e), i)
                    : o.loglevel;
                }),
                (this.enabled = function (e) {
                  return arguments.length
                    ? (f != e && ((f = !!e), i.updateScene(s, !0)), i)
                    : f;
                }),
                (this.destroy = function (e) {
                  ...
                  return (
                    o.container.off('scroll resize', w),
                    d
                      ? TweenLite.ticker.removeEventListener('tick', v)
                      : o.container.off('scroll resize', v),
                    m(
                      3,
                      'destroyed ' +
                        t +
                ...
                var t,
                      ...
                      g.on('change.internal', function (e) {
                        m(),
                          'loglevel' != e.what &&
                            'tweenChanges' != e.what &&
                            ('reverse' != e.what &&
                              null === u.triggerElement &&
                              R(),
                            g.update(),
                            (('DURING' !== d && 'duration' == e.what) ||
                              ('AFTER' === d && 0 === u.duration)) &&
                              y());
                      }),
                  ...
                  m = function () {
                    if (
                      ($.each(u, function (e) {
                        c.hasOwnProperty(e) ||
                          (w(2, 'WARNING: Unknown option "' + e + '"'),
                          delete u[e]);
                      }),
                      (u.duration = parseFloat(u.duration)),
                      (!$.isNumeric(u.duration) || u.duration < 0) &&
                        (w(
                          1,
                          'ERROR: Invalid value for option "duration":',
                          u.duration
                        ),
                        (u.duration = c.duration)),
                      (u.offset = parseFloat(u.offset)),
                      $.isNumeric(u.offset) ||
                        (w(
                          1,
                          'ERROR: Invalid value for option "offset":',
                          u.offset
                        ),
                        (u.offset = c.offset)),
                      null !== u.triggerElement &&
                        0 === $(u.triggerElement).length &&
                        (w(
                          1,
                          'ERROR: Element defined in option "triggerElement" was not found:',
                          u.triggerElement
                        ),
                        (u.triggerElement = c.triggerElement)),
                      $.isNumeric(u.triggerHook) ||
                        -1 != $.inArray(u.triggerHook, a) ||
                        (w(
                          1,
                          'ERROR: Invalid value for option "triggerHook": ',
                          u.triggerHook
                        ),
                        (u.triggerHook = c.triggerHook)),
                      !$.isNumeric(u.loglevel) ||
                        u.loglevel < 0 ||
                        u.loglevel > 3)
                    ) {
                      var e = u.loglevel;
                      (u.loglevel = c.loglevel),
                        w(1, 'ERROR: Invalid value for option "loglevel":', e);
                    }
                  ...
                  R = function () {
                    (h = { start: g.triggerOffset() }),
                      t && (h.start -= t.info('size') * g.triggerHook()),
                  ...
                  y = function (e) {
                    if (o && t) {
                      ...
                      if (
                        ...
                        s.pushFollowers
                          ? 'AFTER' === d &&
                            0 === parseFloat(s.spacer.css('padding-top'))
                            ? (a = !0)
                            : 'BEFORE' === d &&
                              0 ===
                                parseFloat(s.spacer.css('padding-bottom')) &&
                              (a = !0)
                          : (i[n.vertical ? 'top' : 'left'] = u.duration * f),
                          o.css(i),
                          a && (o.removeClass(s.pinnedClass), S());
                      } else {
                        'fixed' != o.css('position') &&
                          (o.css('position', 'fixed'),
                          S(),
                          o.addClass(s.pinnedClass));
                        var l = r(s.spacer, !0),
                          c =
                            u.reverse || 0 === u.duration
                              ? n.scrollPos - h.start
                              : Math.round(f * u.duration * 10) / 10;
                        (l.top -= parseFloat(s.spacer.css('margin-top'))),
                          (l[n.vertical ? 'top' : 'left'] += c),
                          o.css({ top: l.top, left: l.left });
                      }
                    }
                  },
                  S = function () {
                    if (o && t && s.inFlow) {
                      ...
                      c
                        ? ((g['margin-top'] =
                            n || (r && i) ? o.css('margin-top') : 'auto'),
                          (g['margin-bottom'] =
                            e || (r && i) ? o.css('margin-bottom') : 'auto'))
                        : (g['margin-top'] = g['margin-bottom'] = 'auto'),
                        s.relSize.width
                          ? i
                            ? $(window).width() == s.spacer.parent().width()
                              ? o.css('width', 'inherit')
                              : o.css('width', s.spacer.width())
                            : o.css('width', '100%')
                          : ((g['min-width'] = l.outerWidth(!0)),
                            (g.width = i ? g['min-width'] : 'auto')),
                        s.relSize.height
                          ? i
                            ? $(window).height() == s.spacer.parent().height()
                              ? o.css('height', 'inherit')
                              : o.css('height', s.spacer.height())
                            : o.css('height', '100%')
                          : ((g['min-height'] = l.outerHeight(!c)),
                            (g.height = i ? g['min-height'] : 'auto')),
                        s.pushFollowers &&
                          ((g['padding' + (a ? 'Top' : 'Left')] =
                            u.duration * f),
                          (g['padding' + (a ? 'Bottom' : 'Right')] =
                            u.duration * (1 - f))),
                        s.spacer.css(g);
                    }
                  },
                ...
                return (
                  ...
                  (this.duration = function (e) {
                    return arguments.length
                      ? (u.duration != e &&
                          ((u.duration = e),
                          g.trigger('change', { what: 'duration', newval: e })),
                        g)
                      : u.duration;
                  }),
                  (this.offset = function (e) {
                    return arguments.length
                      ? (u.offset != e &&
                          ((u.offset = e),
                          g.trigger('change', { what: 'offset', newval: e })),
                        g)
                      : u.offset;
                  }),
                  ...
                  (this.reverse = function (e) {
                    return arguments.length
                      ? (u.reverse != e &&
                          ((u.reverse = e),
                          g.trigger('change', { what: 'reverse', newval: e })),
                        g)
                      : u.reverse;
                  }),
                  ...
                  (this.loglevel = function (e) {
                    return arguments.length
                      ? (u.loglevel != e &&
                          ((u.loglevel = e),
                          g.trigger('change', { what: 'loglevel', newval: e })),
                        g)
                      : u.loglevel;
                  }),
                  (this.state = function () {
                  ...
                  (this.triggerOffset = function () {
                    ...
                    if (t) {
                      ...
                      if (null === u.triggerElement)
                        e += n.size * g.triggerHook();
                      else {
                        for (
                          var i = $(u.triggerElement).first(),
                            o = r(t.info('container'));
                        ...
                        var s = r(i);
                        n.isDocument ||
                          ((o.top -= n.scrollPos), (o.left -= n.scrollPos)),
                          (e += n.vertical ? s.top - o.top : s.left - o.left);
                      }
                    }
                    return e;
                  }),
                    ...
                    if (t)
                      if (e)
                        if (t.enabled() && p) {
                          var n,
                            r = t.info('scrollPos');
                          null !== u.triggerElement && R(),
                            (n =
                              u.duration > 0
                                ? (r - h.start) / (h.end - h.start)
                                : r >= h.start
                                ? 1
                                : 0),
                            g.trigger('update', {
                  ...
                  (this.progress = function (e) {
                    if (arguments.length) {
                      ...
                      if (
                        (0 >= e && 'BEFORE' !== d && (e >= f || u.reverse)
                          ? ((f = 0), (d = 'BEFORE'), (n = !0))
                          : e > 0 && 1 > e && (e >= f || u.reverse)
                          ? ((f = e), (d = 'DURING'), (n = !0))
                          : e >= 1 && 'AFTER' !== d
                          ? ((f = 1), (d = 'AFTER'), (n = !0))
                          : 'DURING' !== d || u.reverse || y(),
                        n)
                      ) {
                        var o = { progress: f, state: d, scrollDirection: i },
                          s = d != r,
                        ...
                        s &&
                          (('DURING' === d || 0 === u.duration) &&
                            g.trigger('enter', o),
                          ('BEFORE' === d || 'BEFORE' === r) &&
                            g.trigger(a ? 'end' : 'start', o)),
                          g.trigger('progress', o),
                          s &&
                            (('AFTER' === d || 'AFTER' === r) &&
                              g.trigger(a ? 'start' : 'end', o),
                            ('DURING' !== d || 0 === u.duration) &&
                              g.trigger('leave', o));
                      }
                      return g;
                  ...
                  (this.setTween = function (e) {
                    i && g.removeTween();
                    try {
                      i = new TimelineMax({ smoothChildTiming: !0 })
                        .add(e)
                        .pause();
                    } catch (e) {
                      w(
                        1,
                        "ERROR calling method 'setTween()': Supplied argument is not a valid TweenMaxObject"
                      );
                    } finally {
                      return (
                        e.repeat &&
                  ...
                  (this.setPin = function (e, t) {
                    ...
                    if ('fixed' == e.css('position'))
                      return (
                        w(
                          1,
                          "ERROR: Pin does not work with elements that are positioned 'fixed'."
                        ),
                        g
                      );
                    if (o) {
                    ...
                    return (
                      !r &&
                        ...
                        (w(
                          2,
                          'WARNING: If the pinned element is positioned absolutely pushFollowers is disabled.'
                        ),
                        (t.pushFollowers = !1)),
                      (s = {
                        spacer: l,
                      ...
                      s.relSize.width && l.css('width', a.width),
                      s.relSize.height && l.css('height', a.height),
                      o
                        .before(l)
                        .appendTo(l)
                        .css({
                  ...
                  (this.removePin = function (e) {
                    return (
                      o &&
                        (e || !t
                          ? (o
                              .insertBefore(s.spacer)
                              .attr('style', s.origStyle),
                            s.spacer.remove())
                          : 'DURING' === d && y(!0),
                        $(window).off('scroll resize', b),
                        (o = void 0),
                        w(
                          3,
                  ...
                  (this.addTo = function (e) {
                    return t != e
                      ? (t && t.removeScene(g),
                        ...
                        R(),
                        S(),
                        t.info('container').on('resize', F),
                        w(3, 'added ' + l + ' to controller'),
                        e.addScene(g),
                        g.update(),
                        g)
                      : void 0;
                  ...
                  (this.destroy = function (e) {
                    return (
                      ...
                      this.remove(),
                      this.off(
                        'start end enter leave progress change update change.internal progress.internal'
                      ),
                      w(
                        3,
                        'destroyed ' +
                  ...
                  (this.on = function (e, t) {
                    if ($.isFunction(t)) {
                      var n = $.trim(e)
                        .toLowerCase()
                        .replace(/(\w+)\.(\w+)/g, '$1.' + l + '_$2')
                        .replace(/( |^)(\w+)( |$)/g, '$1$2.' + l + '$3');
                      $(g).on(n, t);
                    } else
                      w(
                        1,
                        "ERROR calling method 'on()': Supplied argument is not a valid callback!"
                      );
                    return g;
                  }),
                ...
                if (r)
                  if (r.getBoundingClientRect) {
                    ...
                    (n.top = i.top),
                      (n.left = i.left),
                      t ||
                        ((n.top += $(document).scrollTop()),
                        (n.left += $(document).scrollLeft()));
                  } else
                    (n = e.offset() || n),
                      t &&
                        ((n.top -= $(document).scrollTop()),
